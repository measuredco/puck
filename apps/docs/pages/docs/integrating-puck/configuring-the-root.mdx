...
Configuring the root is similar to [configuring components](configuring-components).
...
We can override the default field configuration by providing custom [Fields](/docs/api-reference/configuration/fields) to the [`fields` parameter](/docs/api-reference/configuration/component-config#fields):
