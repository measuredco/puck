...
If you want to provide the user a way to select the data, you can use the [`external` field type](/docs/api-reference/configuration/fields/external).

## Selecting external data

The [`external` field type](/docs/api-reference/configuration/fields/external) allows users to select tabular data from a third-party data source, like a headless CMS. This will load the data once and save it into the [data payload](/docs/api-reference/data).
