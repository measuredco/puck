...
Puck provides support for nesting components via the [`<DropZone>`](/docs/api-reference/components/drop-zone) component. This can be rendered anywhere within your component, creating a zone that you can drop components into.
