...
[Fields](/docs/api-reference/configuration/fields) allow users to provide input to components. The value of each field is passed in as a prop to the `render` function.
...
This will render a [Text field](/docs/api-reference/configuration/fields/text) when the user selects an instance of the **HeadingBlock** component in the editor UI.
