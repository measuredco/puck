...
- [`usePuck`](/docs/api-reference/functions/use-puck) - access `PuckApi` as part of your component render lifecycle
- [`useGetPuck`](/docs/api-reference/functions/use-get-puck) - receive a getter to access `PuckApi` outside of your component render lifecycle
