...
| --------------------- | ---------------------------------------- | ----------------------------------------------------- | -------- |
| [`content`](#content) | `content: []`                            | [ComponentData](/docs/api-reference/component-data)[] | Required |
...
An array of [ComponentData](/docs/api-reference/component-data) objects representing the component instances in the default content region.
...
An array of [ComponentData](/docs/api-reference/component-data) objects representing the components instances in a particular DropZone.
