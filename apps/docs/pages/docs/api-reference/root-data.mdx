...
An object representing the root data. Similar to [`ComponentData`](/docs/api-reference/component-data).
...
Requires `id` unless used for [`root`](/docs/api-reference/data#root).
