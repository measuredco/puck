...
| [`renderHeader()`](#renderheaderparams)               | `renderHeader: () => <div />`          | Function                                           | Deprecated |
| [`renderHeaderActions()`](#renderheaderactionsparams) | `renderHeaderActions: () => <div />`   | Function                                           | Deprecated |
...
**Deprecated in favour of [`overrides`](#overrides).**
